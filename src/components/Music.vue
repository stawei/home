...
const playerData = reactive({
  server: store.songServer || import.meta.env.VITE_SONG_SERVER,
  type: import.meta.env.VITE_SONG_TYPE,
  id: store.songServer === "tencent"
    ? (import.meta.env.VITE_SONG_ID_QQ || "1171747653")
    : (import.meta.env.VITE_SONG_ID || "5314875708"),
});
...
const handleKeydown = (event) => {
  if (!store.musicIsOk || event.code !== "Space") return;
